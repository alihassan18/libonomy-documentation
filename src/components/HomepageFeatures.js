...
const FeatureList = [
  ...
  },
  {
    ...
    description: (
      <>
        First of its kind AI engine which constantly keeps learning and
        improving to grant the best performance at all times
      </>
    ),
  },
];
    ...
    <div className={clsx("col col--4")}>
      <div className={styles.featureContainer}>
        ...
        <div className={styles.imgMask}>
          <div
            className={isDarkTheme ? styles.imgMaskDark : styles.imgMaskLight}
          >
            <img
  ...
  return (
    <section className={styles.features}>
      <div className="container">
        <div
          className={
            isDarkTheme ? styles.sectionTitleDark : styles.sectionTitleLight
          }
        >
          Libonomy Benefits{" "}
        </div>
