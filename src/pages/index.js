                    ...
                    <div className={(clsx("col col-md-8"), styles.bannerContent)}>
                        <div className={styles.bannerContentWrapper}>
                            ...
                            <div
                                ...
                                allows communities and companies to create faster and more secure
                                decentralized cross chain solutions - digital asset lending and
